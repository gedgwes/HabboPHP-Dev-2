<?php /* Smarty version Smarty-3.1.8, created on 2012-12-02 17:16:56
         compiled from "/Users/robinherzog/github/local/HabboPHP-Dev-2/themes/templates/staff.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162407407850bb7ef820e872-31230755%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1eb917c7010bd08919f4267767b35c31ec1fb84d' => 
    array (
      0 => '/Users/robinherzog/github/local/HabboPHP-Dev-2/themes/templates/staff.tpl',
      1 => 1354465014,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162407407850bb7ef820e872-31230755',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50bb7ef8321929_73897496',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50bb7ef8321929_73897496')) {function content_50bb7ef8321929_73897496($_smarty_tpl) {?>﻿<style>
label{
	width: 150px;
	float:left;
}
...
" style="display:none;">
<img id="f1" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=0&head_direction=0&gesture=std&size=l&img_format=gif" class="active" />
<img id="f2" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=1&head_direction=1&gesture=std&size=l&img_format=gif" />
<img id="f3" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=2&head_direction=2&gesture=std&size=l&img_format=gif" />
<img id="f4" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=3&head_direction=3&gesture=std&size=l&img_format=gif" />
<img if="f5" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=4&head_direction=4&gesture=std&size=l&img_format=gif" />
<img id="f6" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=5&head_direction=5&gesture=std&size=l&img_format=gif" />
<img id="f7" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
&direction=6&head_direction=6&gesture=std&size=l&img_format=gif" />
<img id="f8" src="http://www.habbr.info/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->tpl_vars['item']->value['look'];?>
